...
local function get_groups()
  ...
  local groups = {
    ...
    FloatBorder = config.transparent_mode and { fg = colors.fg1, bg = nil } or { fg = colors.fg1, bg = colors.bg0 },
    ...
    WinBar = { fg = colors.yellow, bg = colors.bg01 },
    WinBarNC = { fg = colors.gray, bg = colors.bg01 },
